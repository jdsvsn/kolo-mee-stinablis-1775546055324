...
const basePath = '/kolo-mee-stinablis-1775546055324';
...
export default function Home() {
  ...
  const products = [{ n: 'Mee Kolo Putih', d: 'Our signature Mee Kolo Putih is a classic take on the traditional kolo mee dish, featuring tender noodles, savory sauce, and a sprinkle of fresh herbs. Made with love and care, this dish is a must-try for any kolo mee enthusiast.', i: 'https://images.pexels.com/photos/15573468/pexels-photo-15573468.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Mee Kolo Merah', d: 'For those who prefer a bit of spice, our Mee Kolo Merah offers a bold and flavorful twist on the original, with a rich and aromatic sauce that will leave you craving for more.', i: 'https://images.pexels.com/photos/8395783/pexels-photo-8395783.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Mee Kolo Kicap', d: 'Our Mee Kolo Kicap is a unique and delicious variation, featuring a sweet and savory soy sauce-based sauce that complements the noodles perfectly, making it a favorite among our regular customers.', i: 'https://images.pexels.com/photos/17951969/pexels-photo-17951969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Wantan', d: 'Our Wantan is a delicious and convenient snack or side dish, featuring tender and flavorful dumplings filled with a secret blend of ingredients, served steamed or fried to perfection.', i: 'https://images.pexels.com/photos/1395319/pexels-photo-1395319.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Mee Pok', d: 'For a comforting and satisfying meal, our Mee Pok is a hearty and flavorful option, featuring flat noodles served in a rich and savory broth, topped with a variety of ingredients to suit your taste.', i: 'https://images.pexels.com/photos/35001779/pexels-photo-35001779.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/8395783/pexels-photo-8395783.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                Kolo mee stinablis is a leading provider of high-quality kolo mee products, dedicated to serving our customers with the best ingredients and cooking methods. Our team of experienced chefs and staff work tirelessly to ensure that every dish that leaves our kitchen meets our high standards of taste and quality. With a passion for innovation and customer satisfaction, we strive to be the go-to destination for kolo mee lovers.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the most recognized and preferred kolo mee brand in the region, known for our exceptional products and outstanding customer service.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To consistently deliver delicious and authentic kolo mee experiences that exceed our customers\' expectations, while maintaining the highest levels of quality, safety, and customer satisfaction.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer First</h4>
                  <p className="text-sm text-on-surface-variant">At Kolo mee stinablis, we prioritize our customers\' needs and preferences, ensuring that every interaction with our brand is met with a personalized and exceptional experience.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Quality</h4>
                  <p className="text-sm text-on-surface-variant">We are committed to serving only the highest-quality kolo mee products, made with the freshest ingredients and careful attention to detail, to guarantee a consistently enjoyable dining experience for our customers.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/23014601/pexels-photo-23014601.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/34177415/pexels-photo-34177415.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/29226696/pexels-photo-29226696.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
